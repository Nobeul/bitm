...
<body>
    ...
    $("#add").click(function(event) {
        ...
        $("#addOrRemove").append(
            ' <label for="exampleInputphone">Participant</label><input type="text" class="form-control" name="participant" placeholder="Enter participant name"><label for="exampleInputphone">abc</label><input type="text" class="form-control" name="participant" placeholder="Enter participant name"><span id="phoneError" style="color: red;"></span>'
        );
